...
const AppTable = () => {
    ...
    const [formdata,setFormData]=useState({isActice:1,stockcheck:[],quantity_pcs:[],quantity_mt:[],rcp:[],dp:[],proptype:[],isEnable:0,iscreditRequired:0,typeOfDispatch:'0',remark:"",expectedDeleveryDate:""})
 ...
 //    })
    ...
    function setdefaultvalue(){
        setFormData({dealerId:"",isActice:1,iscreditRequired:0,typeOfDispatch:'0'})
    }
    ...
    function getSelectedItem(id,data=[],label=''){
        ...
        const item = data.find((opt)=>{
          ...
          if(label)  {
             if (opt.label.toUpperCase == id.toUpperCase)
                return opt;
          }
            else{
                 if (opt.id == id)
            ...
            if(orderid){
                ...
                if(orderDetails){
                    orderDetails.map((orderDetails, index) => {
                        quantity_pcsarr['quantity_pcs_'+orderDetails.skuId]=orderDetails.quantity_pcs
                        quantity_mtarr['quantity_mt_'+orderDetails.skuId]=orderDetails.quantity_mt
                    ...
                    propertyLabels.map((propertyLabels, index) => {
                       proptypearr['proptype_'+propertyLabels.skuPropertiesMastersId]=propertyLabels.label
                    })
    ...
    const getrows = async () => {
            ...
            if(is_skuselected){
                setrows([...rows,{stockcheck: 1 ,quantity_pcs :44 , quantity_mt : 55 ,rcp: 555,dp: 87 }])
                console.log({rows});
    ...
    return (
        <Container>
            ...
            <Button className="rightalign_btn" variant="outlined"
                color="primary" onClick={() => navigate('/order')}>
               Back to Order
            </Button>
            ...
            <ValidatorForm  >
                        ...
                        <Grid item lg={6} md={6} sm={12} xs={12} sx={{ mt: 2 }}>
                            <AutoComplete
                                        fullWidth
                                        defaultValue={getSelectedItem(formdata.dealerId,customeroptions)}
                                        options={customeroptions}
                                        getOptionLabel={(option) => option.label}
                                        onChange={(event, value) => changedropdownvalue('dealerId',value)}
                                        renderInput={(params) => (
                                            <TextField
                                                {...params}
                                                className="required"
                             ...
                             <AutoComplete
                                        fullWidth
                                        defaultValue={getSelectedItem(formdata.skuTypeId,sku_mastersoptions)}
                             ...
                             <TextField
                                ...
                                <AutoComplete
                                        fullWidth
                                        defaultValue={getSelectedItem(formdata.bm,BMoptions)}
                                        options={BMoptions}
                                        getOptionLabel={(option) => option.label}
                                        onChange={(event, value) => changedropdownvalue('bm',value)}
                                        renderInput={(params) => (
                                            <TextField
                                                {...params}
                                                className="required"
                         ...
                         <Grid item lg={6} md={6} sm={12} xs={12} sx={{ mt: 2 }}>
                            <AutoComplete
                                        fullWidth
                                        defaultValue={getSelectedItem(formdata.yardId,yardsoptions)}
                             ...
                             <AutoComplete
                                        ...
                                        multiple
                                        getOptionLabel={(option) => option.label}
                                        onChange={(event, value) => changedropdownvalue('paymentterms',value)}
                                        renderInput={(params) => (
                                            <TextField
                                                {...params}
                                                className="required"
                            ...
                            <div className="datediv">
                                    <LocalizationProvider dateAdapter={AdapterDateFns} >
                                        <DatePicker
                                            /*minDate={new Date()}*/
                                            minDate={todaydate.setDate(todaydate.getDate() + 1)}
                                            open={dateopen}
                                    ...
                                    <FormControlLabel
                                        ...
                                        checked={formdata.iscreditRequired!== '0' && formdata.iscreditRequired ? true : false }
                                        onChange={(e)=>formdatavaluechange(e,'checkbox')}
                                    />
                                </div>
                            </Grid>
                        </Grid>
                        <Button className="orderadd" variant="outlined"
                            color="primary" onClick={addrow}>
                           Add
                        </Button>
                        ...
                        {orderDetails.map((orderDetails, index) => (
                            ...
                            {skuproperties.map((skuproperties,indexinner) => (
                                <td className="dropdowntd"><AutoComplete
                                        defaultValue={getSelectedItem(orderDetails.properties[indexinner].propertyValueId,propertyoptions[skuproperties.skuPropertiesMastersId])}
                             ...
                             /></td>
                                ...
                                <td className="addbtn"><Button  variant="outlined"
                                        color="primary" onClick={()=>handleClickAdd(index)}>Add</Button>
                                </td>
                                <td><TextField
                                isEnable
                                ...
                                <td><TextField
                                    ...
                                    type="text"
                                    fullWidth
                                    name={'quantity_pcs_'+orderDetails.skuId}
                                    value={formdata.quantity_pcs['quantity_pcs_'+orderDetails.skuId]!== undefined && formdata.quantity_pcs['quantity_pcs_'+orderDetails.skuId] ? formdata.quantity_pcs['quantity_pcs_'+orderDetails.skuId] : orderDetails.quantity_pcs }
                                    onChange={(e)=>orderchange(e,orderDetails.skuId,'quantity_pcs')}
                                ...
                                <td><TextField
                                    ...
                                    type="text"
                                    fullWidth
                                    name={'quantity_mt_'+orderDetails.skuId}
                                    value={formdata.quantity_mt['quantity_mt_'+orderDetails.skuId]!== undefined && formdata.quantity_mt['quantity_mt_'+orderDetails.skuId] ? formdata.quantity_mt['quantity_mt_'+orderDetails.skuId] : orderDetails.quantity_mt }
                                    onChange={(e)=>orderchange(e,orderDetails.skuId,'quantity_mt')}
                                    validators={["required","isNumber"]}
                                    errorMessages={["this field is required",'Only Numbers allowed']}
                                /></td>
                                <td><TextField
                                    ...
                                    type="text"
                                    fullWidth
                                    name={'rcp_'+orderDetails.skuId}
                                    value={formdata.rcp['rcp_'+orderDetails.skuId]!== undefined ? formdata.rcp['rcp_'+orderDetails.skuId] : orderDetails.rcp }
                                    onChange={(e)=>orderchange(e,orderDetails.skuId,'rcp')}
                                    validators={['required']}
                                    errorMessages={['this field is required']}
                                /></td>
                                <td><TextField
                                    ...
                                    type="text"
                                    fullWidth
                                    name={'dp_'+orderDetails.skuId}
                                    value={formdata.dp['dp_'+orderDetails.skuId]!== undefined ? formdata.dp['dp_'+orderDetails.skuId] : orderDetails.dp }
                                    onChange={(e)=>orderchange(e,orderDetails.skuId,'dp')}
                                    validators={['required']}
                                    errorMessages={['this field is required']}
                                /></td>
                                <td>
                                    <IconButton onClick={e => handleClickDelete(index,e)} >
                        ...
                        <Grid item lg={6} md={6} sm={12} xs={12} sx={{ mt: 2 }}>
                            ...
                            <TextField
                                ...
                                <TextField
                                    ...
                                    errorMessages={['this field is required','Only Alphanumerics allowed']}
                                />
                                <TextField
                                    className="required"
                                    id="doc_no"
                ...
                <div className="approve_reject">
                        <Button  variant="outlined" color="primary" onClick={()=>handleClickappr_reject(orderid,'Approved')}>
                            Save
                        </Button>
                 </div>      
                </ValidatorForm>
