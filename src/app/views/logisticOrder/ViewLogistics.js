                ...
                <Grid container spacing={3} className="orderview">
                   ...
                   <Grid item lg={6} md={6} sm={12} xs={12} sx={{ mt: 2 }}>
                        <table className="table table-hover table-bordered">
                         <tbody>
                            <tr>
                              <td><Typography><span>vehicle Name</span></Typography></td>
                            ...
                            <tr>
                             ...
                             <tr>
                              <td><Typography><span>vehicle Number</span></Typography></td>
                       ...
                       <table className="table table-hover table-bordered">
                         <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                              <td><Typography><span>vehicle Type</span></Typography></td>
